        ...
        <div className="flex flex-col gap-y-4 items-center justify-center">
          <div className="flex items-center w-full">
            ...
            <div className="border border-link/40 bg-link/10 z-10 rounded-xl px-4 py-1">
              <span className="text-link text-sm font-medium">{DATA.sections.hackathons.label}</span>
            </div>
            <div className="flex-1 h-px bg-linear-to-l from-transparent from-5% via-border via-95% to-transparent" />
          </div>
          <div className="flex flex-col gap-y-3 items-center justify-center">
            <h2 className="text-3xl font-bold tracking-tighter text-center sm:text-4xl">{DATA.sections.hackathons.heading}</h2>
